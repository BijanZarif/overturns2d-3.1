...
c*********************************************************************
      ...
      integer ii,mstop
      character*40 bcfile,integer_string
...
c......set the adjoints objective function
     ...
     +                 cpower_totb, im)
        ...
        print*,'im,fsmachb: ',im,fsmachb
      enddo

!am?!asitav...test
!am?          if (nmesh.gt.1) then
!am?            call do_interpolations(sb,jgmx,kgmx,ibc,imesh,idonor,frac,
!am?     >              nfringe,ndonor,iisptr,iieptr,idsize,isdim,nmesh)
!am?          endif
!am?!asitav
...
c
     ...
     +        ug(:,:,nsp), vg(:,:,nsp), im, jd, kd, bt(:,:,nsp))
      ...
      print*,'im, uinfb,vinfb, einfb:',im,uinfb,vinfb,einfb

...
!asitav !special translation case
      if (motiontype.eq.100.and.iunst.gt.0) rf = fmtip
!asitav
...
c**********************************************************************
      ...
      integer istop,i,i1,ii,im
      logical file_exists
      integer itmp,j1,k1,j2,k2
...
c
     ...
     &reset to 1"
      ...
      if(dt.lt.0.0 .and. iunst.ge.1) then
         if (motiontype.eq.1.or.motiontype.eq.2) then
           if (rf.ne.0.) then
